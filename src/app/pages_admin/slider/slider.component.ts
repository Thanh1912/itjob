...
export class SliderComponent implements OnInit {
  ...
  constructor(private toast: ToastComponent, private job1: JobService, private formBuilder: FormBuilder, private http: Http, private sliderService: sliderService, private Job: JobService, private pagerService: PagerService) { }
  ngOnInit() {
